...
const trainingData = [{ a: 0, b: 0, output: 0 }, { a: 0, b: 1, output: 1 }, { a: 1, b: 0, output: 1 }, { a: 1, b: 1, output: 0 }], testingData = [{ a: 0, b: 0, output: 0 }, { a: 0, b: 1, output: 1 }], dt = new DecisionTree(trainingData, 'output', ['a', 'b'])
